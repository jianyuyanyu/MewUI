...
internal static partial class LibGL
{
    ...
    [LibraryImport(LibraryName)]
    public static partial nint glXChooseFBConfig(
        nint display,
        int screen,
    ...
    [LibraryImport(LibraryName)]
    public static partial nint glXGetVisualFromFBConfig(nint display, nint config);

    [LibraryImport(LibraryName)]
    public static partial int glXGetFBConfigAttrib(nint display, nint config, int attribute, out int value);
